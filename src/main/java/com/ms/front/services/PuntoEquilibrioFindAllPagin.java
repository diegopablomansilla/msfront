...
public class PuntoEquilibrioFindAllPagin extends AbstractFindAllPaginService {
	...
	private Pagin exec(String db, String pageRequest, Integer lastIndexOld, String ejercicioContableId)
		...
		return exec("/PuntoEquilibrio/findAllPagin", db, pageRequest, lastIndexOld, queryParams);
